...
return{
	...
	add_consultant: function(req, res){
		...
		var record =  JSON.parse(req.query.consultant); // .split("-");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
            ...
            // - ex: args: ['10', '2018-04-24', 'Carlos', 'Rangel', 'carlos.jpeg', 'Consultant', '80', 'Blockchain', '3', 'Hyperledger', '', '', '1'], 
            var argList = [
                consultant.Id,
                consultant.DateCreated,
                consultant.FirstName,
				consultant.LastName,
				consultant.AvatarImage,
                consultant.Title,
	...
	request_consultant: function(req, res){
		console.log("submit client request for a consultant asset: ");
        ...
        var sowRequest = {
            Id: array[0],
            DateCreated: array[1],
			TermStartDate: array[2],
            TermEndDate: array[3],
            RequireFullTime: array[4],
            RatePerHour: array[5],
            Status: array[6],
			ClientId: array[7],
			Name: array[8],
            ConsultantId: array[9],
            SOWId: array[10],
            Description: array[11],
            Requirement1: array[12],
            Requirement2: array[13],
            Requirement3: array[14],
        };
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
            ...
            // recordConsultant - requires 8 args: ID, Date Created, First Name, Last name, RatePerHour, Title, Skill Type, Skill Level
			// - ex: args: ['timestamp-ticks', '2018-04-24', 2018-04-24', 'true', '20', '0', '1', '', 'This a sample SOW', 'Complete Project 1', '', ''], 
            var argList = [
                sowRequest.Id,
                sowRequest.DateCreated,
                sowRequest.TermStartDate,
                sowRequest.TermEndDate,
				sowRequest.RequireFullTime,
				sowRequest.RatePerHour,
				sowRequest.Status,
				sowRequest.ClientId,
				sowRequest.Name,
				sowRequest.ConsultantId,
				sowRequest.SOWId,
				sowRequest.Description,
				sowRequest.Requirement1,
				sowRequest.Requirement2,
				sowRequest.Requirement3
            ];

            // requestConsultant - requires 
            // send proposal to endorser
		    const request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'consultant-app',
		        fcn: 'requestConsultant',
		        args: argList,
		        chainId: 'mychannel',
		        txId: tx_id
		    };
